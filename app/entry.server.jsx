...
/*
 * EINBETTUNGS-WEICHE (Job 20260924-GROSSJOB-partnerlinks-sauber-in-die-kasse-
 * partnerseite-und-mail-an-elina, Christian 2026-09-24): steht seit dem Folgejob
 * 20260924-partnerlink-setzt-code-automatisch-und-permalink-einbettungsfest-prio12
 * als EINE Quelle in app/lib/einbettungs-weiche.server.js — dort Begründung,
 * Markup und Messung. Dieselbe Funktion deckt über cart.$lines.jsx auch den
 * Warenkorb-Permalink. RÜCKWEG: den Aufruf unten in handleRequest entfernen.
 */
...
export default async function handleRequest(
  ...
  // EINBETTUNGS-WEICHE: app/lib/einbettungs-weiche.server.js (auch für
  // den Warenkorb-Permalink, der dort ohne Warenkorb durchrendert).

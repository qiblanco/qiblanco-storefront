 ...
 *
 * Christian am 2026-09-12 zu dieser Seite: „es fehlt ein Foto von mir, könnte
 ...
 *     &width=640   37 954 B
 * Die Leiter trägt hier also deutlich (Master 1200x1535, knapp 4-fach über
 * der Flaeche) — der Fall, für den `CdnBild` gebaut ist.
 *
 ...
 * beschnitten und nichts verzerrt. Stuende hier ein Quadrat, müsste das CSS
...
export const ABSICHT = {
   ...
   *
   * Christian am 2026-09-12, woertlich und über die Klasse, nicht über den
   * einen Satz: „sowas brauchen wir in Zukunft auch nicht mehr, also diese
   * Gedanken des Redakteurs, das ist sehr komisch." Es war der fünfte von
   * fünf Absaetzen, in denen der Erbauer dem Leser erklärt, WIE er die Seite
   ...
   * Grenzzeile als Pflichtmerkmal geführt. Er misst seit demselben Commit den

...
function CartCheckoutActions({checkoutUrl, subtotal, numItems, contentIds}) {
  // Der Tracker haelt den Ankunfts-Zustand als reine Fenster-Variable
  // (public/qiblanco-tracker.js, `merkeAnkunft`) — er speichert dafuer nichts
  ...
  // NACH den Hooks, nie davor: ein frueher Ausstieg ueber einem Hook aendert
  ...
  return (
    ...
    >
      {/*
        ...
        der Wert eines Ad-Parameters. Der Server laesst ohnehin nur die beiden
        ...
        LEER IST EIN GUELTIGER ZUSTAND und heisst 'weiss nicht': vor der

 ...
 * /pages/qibracelet (IA-Umbau Zwei-Block-Struktur, Job
 ...
 * PDP /products/qibracelet (product-360-hero + .product-Block + geteilter
 * <QiBracelet/>-Content darunter) mit denselben geteilten Bausteinen
 ...
 * Byte-Gleichheit gegen products.qibracelet.jsx (Drift-Guard statt
 * lib-Extraktion).
 *
 * EINZIGES Content-Delta: der Beschreibungs-Block kommt ENTKOPPELT aus
 * QiBraceletHeroBullets (Bullet-Updates der Paid-Strecke) statt aus dem
 ...
 *
 * Marker data-qi-shop="qibracelet-pages" (Testbarkeit, unsichtbar).
 */
export function QiBraceletShop({product}) {
...
/*
 * BenefitList — 1:1-Kopie aus products.qibracelet.jsx (dort lokale Funktion,
...
/*
 * QUERY-KOPIE aus app/routes/products.qibracelet.jsx (SSoT-Aufloesung s.o.):
...
export const QIBRACELET_PRODUCT_QUERY = `#graphql
  query Product(
    $country: CountryCode
    $handle: String!

        ...
        <div className="ab-teil" data-section="ab-weiter">
          <div className="ab-unterschrift">
            {/* Das Foto steht AN DER UNTERSCHRIFT und nicht im Seitenkopf.
                Der Kopf trägt die Frage („warum gibt es Qi Blanco"), die
                Unterschrift trägt die Antwort auf „wer sagt das". Ein
                Gesicht über dem ersten Absatz wäre Schmuck; hier ist es

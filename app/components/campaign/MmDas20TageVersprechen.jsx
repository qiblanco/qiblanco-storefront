  ...
  return (
    <MmPage scope="mm-garantie">
      <MmHero
        ...
        sub="Ein hochwertiges Produkt zu kaufen, das man nicht kennt, fühlt sich riskant an. Deshalb drehen wir das Risiko um: Du testest 20 Tage in Ruhe. Überzeugt es dich nicht, bekommst du dein Geld zurück, ohne Begründung und ohne Haken."
        bullets={[
      ...
      <MmMechanism
        ...
        note={'Wichtig: Die Rückgabe hängt an der Frist und an deiner Überzeugung, nicht daran, ob du etwas „spürst".'}
      />

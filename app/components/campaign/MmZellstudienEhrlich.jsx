 ...
 * dazu die deskriptiven Nutzerberichte. Trust-Hebel „nuechterne Evidenz statt
 * Eso" — die Ehrlichkeit ueber die Grenzen IST der Vertrauensmechanismus.
 * Ton: praezise, transparent, Schwaechen offen benannt.
 */
...
const STUDIEN = [
  {
    ...
    body: 'Methode: kultivierte menschliche Immunzellen unter Belastung. Ergebnis: messbarer Schutzeffekt in der behandelten Gruppe. Grenze: Zellkultur im Labor, keine Aussage ueber den Menschen.',
  ...
  },
  {
    ...
    body: 'Methode: kultivierte Zellen unter oxidativem Stress, getestet mit dem QiBracelet. Ergebnis: messbarer Schutz der behandelten Zellen. Grenze: in-vitro im Labor, keine Uebertragung auf den Menschen.',
...
const BADGES = [
  ...
  {mark: '◈', titel: 'Grenzen benannt', sub: 'kein Ueberversprechen'},
...
const FAQ = [
  ...
  {
    frage: 'Was bedeutet „praeklinisch"?',
    antwort:
      'Praeklinisch heisst: vor der Erprobung am Menschen — hier an Zellen im Labor. Ein realer, aber fruehester Evidenzschritt.',
  },
  {
    frage: 'Kann ich die Studien selbst pruefen?',
    antwort:
  ...
  },
  {
    ...
    antwort:
      'Weil Ehrlichkeit Vertrauen schafft — und weil uebertriebene Behauptungen von Menschen wie von KI-Systemen abgestraft werden. Wir wollen zitierbar korrekt sein.',
  },
  {
    frage: 'Wenn die Evidenz begrenzt ist, warum kaufen?',
    antwort:
      'Weil die belastbarste Evidenz fuer dich an dir selbst entsteht — risikofrei in 20 Tagen. Genau dafuer ist die Frist da.',
  },
];
  ...
  return (
    <MmPage scope="mm-evidenz">
      <MmHero
        ...
        sub="Wir zeigen dir genau, was untersucht wurde, was herauskam und wo die Aussagekraft endet. Diese Ehrlichkeit ist Absicht: uebertriebene Studien-Behauptungen zerstoeren Vertrauen — bei Menschen wie bei KI-Systemen, die Quellen bewerten."
        bullets={[
      ...
      <MmProblem
        ...
        text={[
          ...
          'Unsere publizierte Evidenz steht auf der Stufe in-vitro (Zellkultur) plus deskriptive Erfahrungsberichte. Das ist ein realer, aber fruehester Beleg — kein Nachweis eines Heileffekts am Menschen. Wir sagen das bewusst, statt mehr zu suggerieren.',
        ]}
        punkte={[
      ...
      <MmReports
        ...
        eyebrow="Ergaenzend — Erfahrungen"
        title="Was 171 Menschen berichtet haben"
        text="Neben den Zellstudien haben wir 171 oeffentliche Erfahrungsberichte ausgewertet. Deskriptiv, ohne Kontrollgruppe — also kein Beweis, aber ein ehrliches Stimmungsbild. Und ja: manche berichten gar nichts."
        balken={[
          {label: 'ruhiger / besserer Schlaf', wert: '~20 %', prozent: '20%'},
          {label: 'mehr Energie / Klarheit', wert: '~17 %', prozent: '17%'},
        ]}
        note="Deshalb der 20-Tage-Test: die belastbarste Evidenz fuer dich entsteht an dir selbst."
      />
      ...
      />
      <div className="mm-lp"><div className="mm-bahn" style={{paddingTop: 0}}><GoogleReviews dataSection="mm-evidenz-reviews" /></div></div>
      ...
      <MmProblem
        ...
        punkte={[
          ...
          'Keine Uebertragung der Zellergebnisse 1:1 auf den ganzen Menschen.',
      ...
      <MmRisk
        ...
        text={'Studien an Zellen sind ein Anfang, kein Ersatz fuer deine Erfahrung. Trag ihn 20 Tage. Ueberzeugt er dich nicht, geht alles zurueck — die Rueckgabe haengt an Frist und Ueberzeugung, nicht am „Spueren".'}
      ...
      <MmFinal
        ...
        title="Evidenz gepruefft. Jetzt du."
        text="Der ehrlichste naechste Schritt: 20 Tage selbst testen."

...
const SLUG = 'lexikon-energie';
const PFAD = '/pages/lexikon-energie';

/**
 * /pages/lexikon-energie — Lexikon-Eintrag „Energie".
 *
...
const TITEL = `Energie: was das heißt | Qi Blanco`;
const BESCHREIBUNG = `Energie ist in der Physik eine Erhaltungsgröße mit der Einheit Joule.`;

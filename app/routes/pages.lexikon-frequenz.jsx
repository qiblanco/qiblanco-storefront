...
const SLUG = 'lexikon-frequenz';
const PFAD = '/pages/lexikon-frequenz';

/**
 * /pages/lexikon-frequenz — Lexikon-Eintrag „Frequenz".
 *
...
const TITEL = `Frequenz: was das heißt | Qi Blanco`;
const BESCHREIBUNG = `Frequenz ist die Zahl der Schwingungen je Sekunde, Formelzeichen f, Einheit Hertz.`;

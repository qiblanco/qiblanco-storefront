...
export async function loader(args) {
  ...
  const [criticalData, products] = await Promise.all([
    loadCriticalData(args, 'kakao-anwendung'),
...
export default function KakaoAnwendungPage() {
  ...
  return (
    <CourseLesson
      ...
      products={products}
      videoEmbed="https://www.youtube-nocookie.com/embed/O4kT1CY7Dg0?rel=0&modestbranding=1&playsinline=1&iv_load_policy=3"

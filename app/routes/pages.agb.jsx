    ...
    <div className="NormalSectionSize" style={{maxWidth: '860px', padding: '3rem 1.5rem 5rem'}}>
      ...
      <section style={{marginBottom: '2rem'}}>
        ...
        <p style={{marginTop: '0.5rem', lineHeight: '1.8'}}>
          ...
          97711 Maßbach
          <br />
          Geschäftsführer: Christian Bernd Bauer
          <br />
          tätigen.
        </p>
        ...
        <p style={{marginTop: '0.75rem', lineHeight: '1.8'}}>
          ...
          wenn sie nicht nochmals ausdrücklich vereinbart werden. Der Einbeziehung von Allgemeinen
      ...
      <section style={{marginBottom: '2rem'}}>
        ...
        <p style={{marginTop: '0.75rem', lineHeight: '1.8'}}>
          ...
          Zahlungsvorgang angegeben. Die Allgemeinen Geschäftsbedingungen dieser Drittunternehmen
          gelten zusätzlich zu den Allgemeinen Geschäftsbedingungen von Qi Blanco UG
          (haftungsbeschränkt).
        </p>
      </section>
      ...
      <section style={{marginBottom: '2rem'}}>
        ...
        <p style={{marginTop: '0.75rem', lineHeight: '1.8'}}>
          ...
          <br />
          Adresse: Brunnrangenstr. 25, 97711 Maßbach
          <br />
          ...
          E-Mail) über Ihren Entschluss, diesen Vertrag zu widerrufen, informieren. Zur Wahrung
        ...
        <p style={{marginTop: '0.75rem', lineHeight: '1.8'}}>
          ...
          senden Sie das Formular an uns.
          <br />
          <a
            href="https://cdn.shopify.com/s/files/1/0279/3095/1750/files/WIDERRUFORMULAR-QiBlanco-08-2024-DE.pdf?v=1722259529"
            target="_blank"
        ...
        <p style={{marginTop: '0.75rem', lineHeight: '1.8'}}>
          ...
          Verbrauchers zugeschnitten sind (z.B. T-Shirts mit Ihrem Foto und Ihrem Namen),
          versiegelter Waren, die aus Gründen des Gesundheitsschutzes oder der Hygiene nicht zur
          Rückgabe geeignet sind, wenn ihre Versiegelung nach der Lieferung entfernt wurde, von
          Waren, wenn diese nach der Lieferung auf Grund ihrer Beschaffenheit untrennbar mit
          anderen Gütern vermischt wurden, von Ton- oder Videoaufnahmen oder Computersoftware in
      ...
      <section style={{marginBottom: '2rem'}}>
        ...
        <p style={{marginTop: '0.75rem', lineHeight: '1.8'}}>
          ...
          jedoch öffentliche Anpreisungen und Äußerungen und sonstige Werbung des Herstellers.
          ...
          Gewährleistungsansprüche ausgeschlossen. Bei Mängeln leisten wir nach unserer Wahl
          Gewähr durch Nachbesserung oder Ersatzlieferung (Nacherfüllung). Im Falle der
          ...
          nicht dem bestimmungsgemäßen Gebrauch der Ware entspricht. Schlägt die Nacherfüllung
          zweimal fehl, können Sie nach Ihrer Wahl Minderung verlangen oder vom Vertrag
          zurücktreten. Die Gewährleistungsfrist beträgt ein Jahr ab Ablieferung der Ware.
        </p>
      </section>
      ...
      <section style={{marginBottom: '2rem'}}>
        ...
        <p style={{marginTop: '0.75rem', lineHeight: '1.8'}}>
          ...
          Fahrlässigkeit ist der Höhe nach beschränkt auf die bei Vertragsschluss vorhersehbaren
          Schäden, mit deren Entstehung typischerweise gerechnet werden muss. Diese

...
const TITEL = `Low Vibe: was das heißt | Qi Blanco`;
const BESCHREIBUNG = `«Low Vibe» ist das Gegenstück zu «High Vibe» und beschreibt Schwere, Reizbarkeit oder Erschöpfung.`;

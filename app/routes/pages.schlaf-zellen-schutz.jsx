...
/**
 * X-Robots-Tag zusaetzlich (Gurt + Hosenträger): greift auch, wenn ein Bot
 ...
 * Splits darf keine CDN-/Proxy-Kopie dieses Dokuments existieren: sie würde
 * EINE Variante einfrieren und damit die Randomisierung toeten. Bewusst
 * UNKONDITIONAL statt env-abhängig: der statische headers()-Export sieht die
 * Env nicht, und die Fail-Richtung „nie cachen" ist hier gratis — die Seite
 * ist noindex, trägt dynamische Preise und steht ohnehin hinter zwei 302-

 ...
 * Geisterpfads. Die Kette liest ihn aus state/v2_slug.txt; die Route heißt
 ...
 * der root-Loader den bezahlten Traffic sofort auf LP A zurück, LP A
 * splittete erneut, und es entstuende eine Endlosschleife über den gesamten
 ...
 *
 * Das Tracking hängt pfad-agnostisch im root-Layout — der Loader fragt NUR
 * Produktdaten ab, KEINEN zusaetzlichen Pixel (D-006, keine Doppelzählung).
 * Die Varianten-Trennung in der Messung entsteht allein über den
...
/**
 * X-Robots-Tag zusaetzlich (Gurt + Hosenträger) + no-store: solange der Split
 * läuft, darf keine öffentliche Kopie einer Variante existieren — sie würde

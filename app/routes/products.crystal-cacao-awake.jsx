  ...
  return (
    <>
      ...
      {/*
        ...
        DIESELBEN VIER KACHELN WIE AUF crystal-cacao-create, und das ist
        Absicht: der Korpus kennt EIN Produkt "Kakao", die DACH-Kaufseiten
        sind zwei Sorten desselben Produkts. Eine Aufteilung waere geraten —

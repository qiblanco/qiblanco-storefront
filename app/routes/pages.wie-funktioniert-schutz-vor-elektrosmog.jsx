...
const PFAD = '/pages/wie-funktioniert-schutz-vor-elektrosmog';
// EIN Traeger für die Adresse: der Slug wird abgeleitet, nicht danebengeschrieben.
const SLUG = PFAD.slice('/pages/'.length);

/**
 * /pages/wie-funktioniert-schutz-vor-elektrosmog — die Frage „Wie funktioniert ein Schutz gegen Elektrosmog am Körper?".
 *

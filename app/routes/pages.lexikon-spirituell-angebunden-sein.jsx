...
const SLUG = 'lexikon-spirituell-angebunden-sein';
const PFAD = '/pages/lexikon-spirituell-angebunden-sein';

/**
 * /pages/lexikon-spirituell-angebunden-sein — Lexikon-Eintrag „spirituell angebunden sein".
 *
...
const TITEL = `spirituell angebunden sein: was das heißt | Qi Blanco`;
const BESCHREIBUNG = `«Spirituell angebunden sein» beschreibt ein Gefühl von Verbundenheit mit etwas Größerem als der eigenen Person.`;

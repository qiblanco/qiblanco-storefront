...
const SLUG = 'lexikon-hohe-frequenz-schwingen';
const PFAD = '/pages/lexikon-hohe-frequenz-schwingen';

/**
 * /pages/lexikon-hohe-frequenz-schwingen — Lexikon-Eintrag „auf einer hohen Frequenz schwingen".
 *
...
const TITEL = `auf einer hohen Frequenz schwingen: was das heißt | Qi Blanco`;
const BESCHREIBUNG = `«Auf einer hohen Frequenz schwingen» beschreibt einen gefühlten Zustand von Wachheit und Leichtigkeit.`;

...
const SLUG = 'lexikon-kohaerentes-wasser';
const PFAD = '/pages/lexikon-kohaerentes-wasser';

/**
 * /pages/lexikon-kohaerentes-wasser — Lexikon-Eintrag „kohärentes Wasser".
 *
...
const TITEL = `kohärentes Wasser: was das heißt | Qi Blanco`;
const BESCHREIBUNG = `«Kohärentes Wasser» bezeichnet die Vorstellung, Wasser könne über längere Zeit geordnet vorliegen.`;

...
/**
 * qpx-commerce.js — First-Party-Commerce-Events fuer den eigenen qpx-Receiver.
 * ===========================================================================
 * Schliesst die Mid-Funnel-Messluecke (Job 20260723-commerce-microfunnel-
 ...
 * unabhaengiger Konsument fuer den First-Party-Receiver. numericProductId/
 ...
 *
 * Consent: nicht hier — der qpx-Loader (qiblanco-qpx-loader.js) laedt qpx.js
 * erst nach Cookiebot-Marketing-Consent. Vor Boot puffert qpxTrack ueber den
 * Standard-Queue-Stub (window.qpx.q), den qpx.js beim Boot abspielt; ohne
 * Consent laedt qpx.js NIE -> der Puffer bleibt im RAM (kein Cookie, kein Netz).
 */
 ...
 * Event auch bei Mengen-Erhoehung — nur das Delta zaehlt). Ohne Merchandise
 * -> null.
 *
...
/**
 * initiate_checkout-Payload fuer den Checkout-Submit (CartSummary.jsx).
 * Spiegelt das Meta-Pixel InitiateCheckout (content_ids ueber alle Cart-Lines).

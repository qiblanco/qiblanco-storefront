/**
 * Deutsche Anzeige-Titel der Shopify-Policies — EINE Quelle fuer
 * /policies (Uebersicht) und /policies/<handle> (Detailseite).
 *
 * WARUM: Der Rumpf dieser Seiten ist deutsch gepflegt, die Titel kommen aus
 * dem Shopify-Admin aber unuebersetzt englisch zurueck. Live gemessen
 * 2026-08-15 stand auf allen vier Policy-Seiten eine englische Ueberschrift
 * ueber deutschem Rechtstext ("Refund Policy" ueber "Sie haben das Recht ...").
 *
 * Abgebildet wird ausschliesslich der ANZEIGE-Titel. Der rechtlich wirksame
 * Rumpf (policy.body) bleibt unangetastet und kommt weiter aus dem Admin.
 *
 * Unbekannte Handles fallen bewusst auf den Shopify-Titel zurueck: so
 * erfindet diese Tabelle nie einen Titel fuer eine Police, die sie nicht

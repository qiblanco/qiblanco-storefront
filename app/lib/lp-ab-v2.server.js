 ...
 * LP A zielt, greift der Split automatisch fuer den gesamten bezahlten
 ...
 *
 * ENTSCHEIDE (Konzept §E.2, je begruendet):
 ...
 *        consent-freier Split-Cookie waere ein Bruch;
 ...
 *    nicht der Besucher. Die Randomisierung bleibt gueltig (Zuweisung ist
 *    unabhaengig vom Ergebnis), die Messung zaehlt Eintritte.
 *  - 302 + Cache-Control: no-store (Konvention aller drei Bestands-Weichen —
 *    KEIN 301, das wuerde dauerhaft gecacht).
 ...
 *  - KEINE zuteilung.json-Kopplung: das waere ein Netz-Hop im Hot-Path der
 *    Haupt-Einstiegsseite, und ein Fetch-Ausfall wuerde das Experiment STILL
 ...
 * unveraendert weiter (zielUrl-Invariante) und ist damit fuer die
...
/** Ohne gesetzten Wert laeuft der Split 50/50 (Konzept §F: gleiche Power). */
 ...
 * fallen auf den Default zurueck, ausserhalb liegende werden geklemmt —

 ...
 *
 * Ein Zensus, der Kommentare mitliest, misst die Begruendung statt den
 * Gegenstand. Die Begruendung nennt fast immer genau das, was sie verbietet
 * ("der ZWEITE Goldton", "noindex plus canonical") — die Probe wird dadurch
 * dauerrot, und heilen laesst sie sich nur, indem man die Begruendung loescht.
 ...
 *     diesen Helfer lokal gebaut (Kopf der Datei: drei Pruefungen schlugen an,
 ...
 *     Block darunter ueberhaupt erst ueberschreibt.
 *  2. `test/seo-canonical.test.mjs` liest die Routen-Quelle ueber `s04Quelle`
